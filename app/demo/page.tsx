...
import { CheckCircle2, Sparkles, Send, ShieldCheck, ArrowRight, RefreshCw, MessageSquare } from 'lucide-react';
    ...
    <div className="pt-28 pb-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
      ...
      <div className="text-center max-w-2xl mx-auto space-y-3">
        ...
        <h1 className="text-4xl sm:text-5xl font-extrabold text-slate-900 dark:text-white tracking-tight">
          Book a Live <span className="gradient-text">WhatsApp API Demo</span>
        </h1>
      ...
      {submittedLead ? (
        /* Success State View */
        <div className="glass-card rounded-3xl p-8 sm:p-12 border border-emerald-500/50 shadow-2xl text-center space-y-6 animate-in zoom-in-95 duration-300">
          ...
          <div className="bg-slate-100 dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 text-left text-xs space-y-2 max-w-md mx-auto">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-mono text-slate-400">{submittedLead.id || submittedLead.$id}</span>
            </div>
          </div>
          ...
          <div className="pt-2">
            <button
              ...
              className="px-6 py-3 bg-slate-900 dark:bg-slate-800 text-white font-semibold text-sm rounded-xl hover:bg-slate-800 transition-colors"
            >
        ...
        /* Demo Request Form */
        <div className="glass-card rounded-3xl p-6 sm:p-10 border border-slate-200 dark:border-slate-800 shadow-2xl space-y-6">
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-slate-950 font-bold text-base rounded-2xl shadow-xl shadow-emerald-500/25 flex items-center justify-center gap-2 transition-all active:scale-[0.99] disabled:opacity-50"
            >
              {loading ? (
                <>
                  <RefreshCw className="w-5 h-5 animate-spin" />
                  Storing Request in Appwrite Database...
                </>
              ) : (
                <>
