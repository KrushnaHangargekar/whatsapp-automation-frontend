        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-slate-50 dark:bg-slate-800/60 p-6 rounded-lg border border-slate-200 dark:border-slate-700 flex flex-col justify-between space-y-4 hover:border-emerald-500/50 transition-colors"
              >
                <div className="space-y-3">
                  <div className="w-10 h-10 rounded-md bg-emerald-100 dark:bg-emerald-950/60 flex items-center justify-center text-[#006d2f] dark:text-[#25D366]">
                ...
                <Link
                  href="/features"
                  className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#006d2f] dark:text-[#25D366] hover:underline pt-2"
                >
